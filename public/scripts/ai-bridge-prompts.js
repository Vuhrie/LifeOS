...
export const buildAiBridgePrompt = (context) => {
  return [
    ...
    "Return an organized reasoning section first, then the JSON patch.",
    ...
    "- Reasoning must be outside the JSON in a clearly organized section.",
    "- In reasoning, cover why each operation is needed, which constraints were considered, how the schedule context affected decisions, and any tradeoffs or unscheduled limitations.",
    "- Put the JSON patch last in a fenced ```json block so LifeOS can import it.",
    "",
