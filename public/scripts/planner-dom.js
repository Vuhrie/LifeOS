...
export const getPlannerUi = () => ({
  ...
  addGoal: $("#add-goal"),
  majorGoalMode: $("#major-goal-mode"),
  majorGoalModeButtons: [...document.querySelectorAll("[data-major-goal-mode]")],
  majorGoalManualFields: $("#major-goal-manual-fields"),
  majorGoalAiFields: $("#major-goal-ai-fields"),
  ...
  majorGoalAiImportInput: $("#major-goal-ai-import-input"),
  majorGoalAiValidateImport: $("#major-goal-ai-validate-import"),
  majorGoalAiApplyImport: $("#major-goal-ai-apply-import"),
  majorGoalAiClearImport: $("#major-goal-ai-clear-import"),
  majorGoalAiStatus: $("#major-goal-ai-status"),
  ...
  commitProgressPhase: $("#commit-progress-phase"),
  commitProgressBar: $("#commit-progress-bar"),
  commitProgressMeta: $("#commit-progress-meta"),
  commitProgressCurrent: $("#commit-progress-current"),
  commitProgressCounts: $("#commit-progress-counts"),
  commitProgressLog: $("#commit-progress-log"),
